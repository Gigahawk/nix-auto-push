  ...
  outputs =
    ...
    flake-utils.lib.eachDefaultSystem (
      ...
      let
        ...
        virtualenv = editablePythonSet.mkVirtualEnv "nix-auto-push-dev-env" workspace.deps.all;
      ...
      in
      {
        packages = {
          nix-auto-push = mkApplication {
            venv = pythonSet.mkVirtualEnv "nix-auto-push-app-env" workspace.deps.default;
            package = pythonSet.nix-auto-push;
          };
          default = self.packages.${system}.nix-auto-push;
        };
        formatter = treefmtEval.config.build.wrapper;
        checks = {
          formatting = treefmtEval.config.build.check self;
          # Doesn't seem to work
          # pytest = editablePythonSet.nix-auto-push.passthru.tests.pytest;
        };
        devShells = {
